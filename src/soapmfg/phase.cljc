(ns soapmfg.phase
  "Phase 0->3 staged rollout for the soap-and-detergent, cleaning-and-
  ...
  consequence (a saponification/mixing/formulation-kettle or
  filling-line maintenance window means production downtime, and the
  equipment ends up actually touched); it is always a human plant
  supervisor's call. `soapmfg.governor`'s `line-actuate-blocked-
...
(defn verdict->disposition
  "Map a Soap & Detergent Plant Operations Governor verdict to a base
