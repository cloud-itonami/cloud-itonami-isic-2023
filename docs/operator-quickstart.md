# Operator Quickstart — Manufacture of soap and detergents, cleaning and polishing preparations, perfumes and toilet preparations

Shortest path from clone to a verified local dry-run for **ISIC 2023** (`cloud-itonami-isic-2023`).
...
```bash
git clone https://github.com/cloud-itonami/cloud-itonami-isic-2023.git
cd cloud-itonami-isic-2023
```
...
- Blueprint governor key: `soap-detergent-plant-operations-governor`
- Likely source path: `soapmfg.governor.cljc`
