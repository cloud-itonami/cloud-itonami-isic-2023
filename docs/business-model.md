# Business Model: Manufacture of soap and detergents, cleaning and polishing preparations, perfumes and toilet preparations
...
## Classification
- Repository: `cloud-itonami-isic-2023` ([github.com/cloud-itonami/cloud-itonami-isic-2023](https://github.com/cloud-itonami/cloud-itonami-isic-2023))
- ISIC Rev.5: `2023` — Manufacture of soap and detergents, cleaning and polishing preparations, perfumes and toilet preparations
- Domain: `:soap-detergent-cosmetics/manufacturing`
- Social impact: :worker-safety :consumer-safety :materials-safety
- Actor: `:soap-detergent-plant-operations-governor` — an independent Governor in the fleet's Sealed-LLM
...
## Customer
An operator running this vertical as an OSS business — :soap-detergent-cosmetics/manufacturing — who wants
...
One managed tenant (:soap-detergent-cosmetics/manufacturing):
...
- Do not bypass the `:soap-detergent-plant-operations-governor` for production decisions.
